...
const HorseRace: React.FC = () => {
  ...
  return (
    <div className="horse-race-container">
      ...
      <p>Tech demo for SSE (Server side events) by Steffen Weidenhaus. Make sure to open it in several browser sessions at once.</p>
      <p>Each horse has a random speed and the first to reach the finish line wins.</p>
      <a href="https://github.com/weidenhaus/horserace">Code on GitHub</a>
